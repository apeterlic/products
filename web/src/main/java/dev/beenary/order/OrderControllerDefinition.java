...
import static dev.beenary.SortingFilter.DEFAULT_SORT_COLUMN;
import static dev.beenary.SortingFilter.DEFAULT_SORT_DIRECTION;
...
public interface OrderControllerDefinition {
     ...
     * @param sortDirection [{@link dev.beenary.SortingFilter.SortDirection}] :: sort direction
     *                      (optional)
     * @param createdAt     [{@link LocalDateTime}] :: time period when order was created
